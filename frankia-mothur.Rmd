...
jpeg(filename="bs_tree_nifH_clean2.jpg", width=15,height=15, units="in", res=300)
NNL
dev.off()
...
dev.off()
jpeg(filename = "Plot_1_zoom20.jpeg",units="in",width =7, height=7, res=300) #saves graph output
...
maps <- grid.arrange(plot_1, plot_2, plot_3, plot_4, plot_5, bigmap, ncol=1, nrow=5)
...
dev.off()
jpeg(filename = "panel_zoom20.jpeg",units="in",width =7, height=7, res=300) #saves graph output
